  ...
  return (
    <section className="w-full bg-[#FCFCFD] py-7 md:py-[110px]">
      <section className="container px-4 mx-auto">
        <h6 className="text-[32px] md:text-[48px] font-extrabold md:font-semibold text-[#23262F] text-center max-w-[825px] mx-auto leading-none font-dmsans">
          How It Works: A done for you service
        </h6>
        <p className="my-4 text-sm lg:text-2xl font-geist text-[#777E90] text-center max-w-[627px] mx-auto">
          A Simple, Quick, and Fully Managed App-Building Process
        </p>
        <div className="mt-6 md:mt-[60px] relative">
          {/* first */}
          <div className="flex items-center lg:justify-center gap-5 lg:gap-[50px] relative z-10">
            ...
            <div className="lg:basis-[47%]">
              ...
              <p className="text-sm font-geist text-[#777E90] max-w-[575px]">
          ...
          {/* second  */}
          <div className="flex items-center lg:justify-center gap-5 lg:gap-[50px] my-[50px] lg:my-[40px] relative z-10">
            <div className="basis-[47%] hidden lg:block">
              <h6 className="text-2xl lg:text-[32px] font-extrabold font-dmsans text-[#23262F] text-right">
                7-Day App Build
              </h6>
              <p className="text-sm font-geist text-[#777E90] pl-5 text-right">
            ...
            <div className="lg:basis-[47%]">
              ...
              <p className="text-sm font-geist text-[#777E90] block lg:hidden">
                Sit back and relax while our expert team builds your app within
                7 days. We handle all the design, development, and integration
                to ensure a seamless experience.
              </p>
          ...
          {/* border linear */}
          <div className="absolute top-[19%] left-[6.5%] sm:left-[3.2%] lg:left-1/2 z-0 flex flex-col gap-1">
            <svg
             className="hidden lg:block"
              width="2"
              height="300"
